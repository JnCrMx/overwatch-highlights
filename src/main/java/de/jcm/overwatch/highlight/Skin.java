...
public enum Skin
{
	...
	D_VA_PALANQUIN(6681, Hero.D_VA, "Palanquin", Category.LUNAR_NEW_YEAR, Rarity.LEGENDARY),
	D_VA_LEAGUE_ATLANTA_REIGN(11320, Hero.D_VA, "Atlanta Reign", Category.OVERWATCH_LEAGUE, Rarity.EPIC),

	DOOMFIST_PLAINS(5650, Hero.DOOMFIST, "Plains", Category.OVERWATCH, Rarity.RARE),
	DOOMFIST_JOETUNN(11403, Hero.DOOMFIST, "Jötunn", Category.WINTER_WONDERLAND, Rarity.LEGENDARY),
	...
	HANZO_CASUAL(6578, Hero.HANZO, "Casual", Category.WINTER_WONDERLAND, Rarity.LEGENDARY),
	...
	LUCIO_RIBBIT(6008, Hero.LUCIO, "Ribbit", Category.OVERWATCH, Rarity.LEGENDARY),

	MCCREE_UNDEAD(8653, Hero.MCCREE, "Undead", Category.HALLOWEEN_TERROR, Rarity.EPIC),
	MCCREE_BLACKWATCH(6582, Hero.MCCREE, "Blackwatch", Category.ARCHIVES, Rarity.LEGENDARY),
	...
	MERCY_COBALT(6319, Hero.MERCY, "Cobalt", Category.OVERWATCH, Rarity.EPIC),
	MERCY_EIDGENOSSIN(6521, Hero.MERCY, "Eidgenossin", Category.SUMMER_GAMES, Rarity.EPIC),
	...
	MERCY_LEAGUE_HANGZHOU_SPARK(11076, Hero.MERCY, "Hangzhou Spark", Category.OVERWATCH_LEAGUE, Rarity.EPIC),
	...
	REAPER_NEVERMORE(6000, Hero.REAPER, "Nevermore", Category.OVERWATCH, Rarity.LEGENDARY),
	REAPER_PLAGUE_DOCTOR(6001, Hero.REAPER, "Plague Doctor", Category.OVERWATCH, Rarity.LEGENDARY),
	...
	REINHARDT_GREIFHARDT(6485, Hero.REINHARDT, "Greifhardt", Category.OVERWATCH, Rarity.LEGENDARY),

	ROADHOG_BUTCHER(7195, Hero.ROADHOG, "Butcher", Category.OVERWATCH, Rarity.LEGENDARY),
	ROADHOG_ISLAND(5792, Hero.ROADHOG, "Island", Category.OVERWATCH, Rarity.LEGENDARY),
	ROADHOG_TOXIC(10765, Hero.ROADHOG, "Toxic", Category.ANNIVERSARY, Rarity.LEGENDARY),
	...
	SYMMETRA_FIGURE_SKATER(8499, Hero.SYMMETRA, "Figure Skater", Category.WINTER_WONDERLAND, Rarity.LEGENDARY),
	...
	ZENYATTA_RA(5631, Hero.ZENYATTA, "Ra", Category.OVERWATCH, Rarity.LEGENDARY),
	ZENYATTA_CULTIST(7143, Hero.ZENYATTA, "Cultist", Category.HALLOWEEN_TERROR, Rarity.LEGENDARY),
	;
